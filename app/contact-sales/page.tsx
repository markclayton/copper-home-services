  ...
  return (
    ...
    >
      <p className="text-base">
        Most small businesses fit cleanly into Solo or Business. The Custom
        plan is for operations that need something the self-serve tiers
        don&apos;t cover — multiple locations under one roof, integrations
        with your CRM, dispatch, or scheduling software, or hands-on setup
        and training for a larger team.
      </p>
