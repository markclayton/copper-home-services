  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Pick how your AI sounds, and tell it what counts as an emergency. You
        can edit all of this later in Settings.
      </p>
      ...
      <form action={formAction} className="flex flex-col gap-5">
        ...
        <div className="grid gap-2">
          ...
          <p className="text-xs text-muted-foreground">
            Pick the voice your callers will hear. You can change this anytime.
          </p>
        </div>

        <div className="grid gap-2">
          <Label htmlFor="brandVoiceNotes">Personality notes (optional)</Label>
          <textarea
            id="brandVoiceNotes"
          ...
          />
          <p className="text-xs text-muted-foreground">
            Tone or word-choice quirks. Doesn&apos;t change the voice itself.
          </p>
        </div>
